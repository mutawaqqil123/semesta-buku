<x-template>
  <x-slot:title>Admin Semesta Buku - Blog Edit {{ $blog->title }}</x-slot:title>
  <div class="page-body">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            <form action="{{ route('blogs.update', $blog->token_blog) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <img id="thumbnail-preview" src="{{ asset($blog->thumbnail) }}" alt="Preview" class="img-fluid mt-2"
